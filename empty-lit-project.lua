--- empty-lit-project.lua - create an empty love2d project based on the
--folder at lit-empty-love2d-project in a new folder given by the user
--
-- date: 23/03/2024
...
local TEMPLATE_PROJECT_FOLDER = "lit-empty-love2d-project"
